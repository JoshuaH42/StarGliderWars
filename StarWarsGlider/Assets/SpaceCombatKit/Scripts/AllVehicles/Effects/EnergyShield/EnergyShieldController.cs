...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class EnergyShieldController : MonoBehaviour
    {
        ...
        public virtual void OnDamaged(float damageValue, Vector3 hitPosition, Transform damageSourceRootTransform)
        {
        ...
        /// <param name="hitPosition">World space hit position.</param>
        public virtual void OnHealed(float healValue, Vector3 hitPosition, Transform damageSourceRootTransform)
        {
