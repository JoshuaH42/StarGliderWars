...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class VehicleCamera : MonoBehaviour
    {
        ...
        public OnVehicleCameraViewTargetChangedEventHandler onVehicleCameraViewTargetChanged;
        ...
        protected virtual void Awake()
		{
            ...
            {
                onVehicleCameraViewTargetChanged.AddListener(auxiliaryCameraController.OnCameraViewTargetChanged);
