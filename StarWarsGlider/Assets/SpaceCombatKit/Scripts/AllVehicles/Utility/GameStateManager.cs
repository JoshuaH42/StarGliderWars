...
namespace VSX.UniversalVehicleCombat
{
    ...
    public class GameStateInstance
    {
        ...
        public List<GameState> allowedOriginStates = new List<GameState>();
    ...
    public class GameStateManager : MonoBehaviour
    {
        ...
        public void EnterGameState(string newGameStateName)
        {
            int index = new List<string>(System.Enum.GetNames(typeof(GameState))).IndexOf(newGameStateName);
        ...
        { 
            ...
            for (int i = 0; i < gameStates.Count; ++i)
            {
                if (gameStates[i].gameState == newGameState)
                {
                    ...
                    {
                        bool allow = false;
                        foreach (GameState allowedOriginState in gameStates[i].allowedOriginStates)
                        {
