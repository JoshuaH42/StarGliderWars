...
namespace VSX.UniversalVehicleCombat.Space
{
    ...
    public class SpaceFighterCameraController : VehicleCameraController
    {
        ...
        protected override bool Initialize(Vehicle vehicle)
        {
            ...
            return (vehicleRigidbody != null && vehicleEngines != null);
        ...
        protected virtual void FixedUpdate()
        {
            ...
            // Get the spin of the vehicle 
            Vector3 spin = vehicleRigidbody.angularVelocity;

            // Calculate the lateral offset from the camera view target based on the spin.
            float spinLateralOffset = vehicleCamera.SelectedCameraViewTarget.SpinOffsetCoefficient * vehicleCamera.SelectedCameraViewTarget.transform.InverseTransformDirection(spin).z;
        ...
        protected void Update()
        {
            ...
            {
                float targetFieldOfView = vehicleEngines.BoostThrottleValues.z * boostFieldOfView + 
                                    (1 - vehicleEngines.BoostThrottleValues.z) * vehicleCamera.DefaultFieldOfView;
